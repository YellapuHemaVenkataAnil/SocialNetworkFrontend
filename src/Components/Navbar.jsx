    ...
    <div className="navbar">
      ...
      <div className="profile">
        <div className="text-section">
          <div className="profile-item text-item">Demo</div>
          <div className="my-netword text-item">Pages</div>
          <div className="profile-item text-item">Account</div>
          <div className="profile-item text-item">My Profile</div>
